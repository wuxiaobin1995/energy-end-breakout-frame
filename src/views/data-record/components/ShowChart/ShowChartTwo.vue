 ...
 * @LastEditTime: 2020-09-21 09:18:58
 * @Description : ShowChart子组件：速度与功率
-->
<template>
  <div class="container">
    <el-button
...
export default {
  ...
  methods: {
    ...
    setRowData() {
      /* 功率 */
      const newPowerDataArray = this.rowData.powerDataArray

      /* 速度单位转换，把 cm/s -> m/s */
      const newSpeedDataArray = []
      this.rowData.speedDataArray.forEach(item => {
