 ...
 * @LastEditTime: 2022-12-16 16:51:12
 * @Description : 数据迁移
-->
<template>
  <div class="data-migration" v-loading.fullscreen.lock="fullscreenLoading">
    <div class="wrapper">
      <el-page-header
        class="page"
        title="返回首页"
          ...
          db.user
            ...
            .then(res1 => {
              db.action
                ...
                .catch(err => {
                  this.$confirm(`导出action表数据失败：${err}`, '提示', {
                    type: 'warning',
                    center: true,
                    showClose: false,
                    closeOnClickModal: false,
